...
Let's create 2 Virtual Machines first on  which we will distribute the load.

        1. Login to Azure portal and search for Virtual Machines in searchbar.
        2. Click on + to start creating one.

        
<img width="878" alt="image" src="https://github.com/SRJ1307/LoadBalancing-VirtualMachine/assets/157812379/9ca8f198-c41a-4f9e-8d5b-2fff269678c5">
        
        
        Follow the images to create one.
       
<img width="592" alt="image" src="https://github.com/SRJ1307/LoadBalancing-VirtualMachine/assets/157812379/3ae5d433-8714-4095-8a7a-72d46be9533a">

    Now move to networking Section.
    Here you need tto create a V-Net. Remember this same V-net will be used while creating the 2nd Virtual Machine.
    Now review + Create, we can ignore other options as that are not required fot this case.
    Repeat the same process once more to ceate the 2nd VM.
    Once our VMs are create let's create a Load Balancer.
